...
def test_deve_permitir_propor_lance_quando_o_valor_eh_igual_o_valor_da_carteira(
    vini, leilao
):
...
def test_deve_negar_propor_lance_quando_o_valor_eh_maior_que_o_valor_da_carteira(
    vini, leilao
):
